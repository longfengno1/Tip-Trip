...
var S = {
  init: function () {
    ...
    S.Drawing.init('.canvas1');
    document.body.classList.add('body--ready');

    if (i !== -1) {
      S.UI.simulate(decodeURI(action).substring(i + 3));
    } else {
      S.UI.simulate('Tip|Trip|Welcome|#rectangle|#countdown 3|Tip & Trip');
    }
...
S.Drawing = (function () {
  ...
  return {
    ...
    adjustCanvas: function () {
		canvas.width = $(".banner-info").width();	  
    canvas.height = $(".banner-info").height()+300;
    },
...
S.ShapeBuilder = (function () {
  ...
  function fit() {
	...
	if(shapeCanvas.width>1300){
		shapeCanvas.width = Math.floor((window.innerWidth-150 )/ gap) * gap
	}
